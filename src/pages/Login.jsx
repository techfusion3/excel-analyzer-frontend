...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Updated Redux state with:', response); // Debug log
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24 bg-[#1b1b1d]">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="text-center">
            <h2 className="mt-2 sm:mt-6 text-3xl font-bold tracking-tight text-[#FFFFFF]">
              Welcome back
            </h2>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="font-medium text-[#f02e65] hover:text-[#f02e65]/90">
                    Forgot password?
                  </Link>
                </div>
              </div>
